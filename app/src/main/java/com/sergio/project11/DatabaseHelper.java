...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table nota (alumno_id integer not null, asignatura_id integer not null, trimestre integer not null, nota real default null, foreign key (alumno_id) references alumno(id_al), foreign key (asignatura_id) references asignatura(id_asig), primary key (alumno_id, asignatura_id, trimestre))");
